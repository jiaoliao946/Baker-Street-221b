//原：https://cdn.jsdelivr.net/npm/docsify
!function () {
    function c(i) {
    ...
    I.prototype.getFile = function (e, n) {
      ...
      return e = t.alias ? function e(n, i, o) {
        var t = Object.keys(i).filter(
          function (e) {
            return (M[e] || (M[e] = new RegExp('^' + e + '$'))).test(n) &&
            n !== o
          }
        ) [0];
      ...
      o = r,
      e = (
        e = new RegExp('\\.(' + o.replace(/^\./, '') + '|html)$', 'g').test(i) ? i : /\/$/g.test(i) ? i + 'README' + o : '' + i + o
      ) === '/README' + r &&
      t.homepage ||
      e,
      e = R(e) ? e : q(a, e),
    ...
    I.prototype.toURL = function (e, n, i) {
      ...
      if (
        ...
        o &&
        (e = (0 < (o = i.indexOf('?')) ? i.substring(0, o) : i) + e),
    ...
    function G(e) {
      ...
      t = e.step;
      Z ||
      ((e = w('div')).classList.add('progress'), r(h, e), Z = e),
    ...
    function X(t, e, n) {
      ...
      for (i in r.open('GET', t), n) u.call(n, i) &&
      r.setRequestHeader(i, n[i]);
      return r.send(),
      {
        then: function (n, i) {
          var o;
    ...
    function K() {
      ...
      (
        ...
        n.classList.contains('hidden') ? S(h, 'add', 'sticky') : S(h, 'remove', 'sticky')
      )
    }
    function ee(e, n, o, i) {
      var t = [];
      ...
      return t.sort(function (e, n) {
        ...
        function (e) {
          ...
          e.innerText,
          0 !== r.indexOf(n) ||
          a ? S(i, 'remove', 'active') : (a = e, S(i, 'add', 'active'))
        }
      ),
      i &&
      (v.title = a ? a.title ||
    ...
    function ue(e) {
      ...
      if (o) for (var t in i) !u.call(i, t) ||
      f(n = o.getAttribute('data-' + a(t))) &&
      (i[t] = '' === n || n);
      return !0 === i.loadSidebar &&
      (i.loadSidebar = '_sidebar' + i.ext),
      !0 === i.loadNavbar &&
      (i.loadNavbar = '_navbar' + i.ext),
      !0 === i.coverpage &&
      (i.coverpage = '_coverpage' + i.ext),
      !0 === i.repo &&
      (i.repo = ''),
      !0 === i.name &&
      (i.name = ''),
    ...
    function he(e, n) {
      ...
      (
        ...
        e = fe[ve(e, n)],
        (n = b(l('.sidebar'), 'li.active')) &&
        n.classList.remove('active'),
        e &&
        e.classList.add('active')
      )
    }
    var _e = v.scrollingElement ||
    v.documentElement;
    ...
    Ue = function (e) {
      for (var n, i, o = arguments, t = 1; t < arguments.length; t++) for (i in n = o[t]) Object.prototype.hasOwnProperty.call(n, i) &&
      (e[i] = n[i]);
      return e
    },
    Ze = function (e, n) {
    ...
    Ve = function (e, n) {
      ...
      for (var i = e.length, o = 0, t = 0; t < i; t++) if ('\\' === e[t]) t++;
       else if (e[t] === n[0]) o++;
    ...
    var nn = function () {
          ...
          e = function (e, n) {
            ...
            return n.split('\n').map(
              function (e) {
                var n = e.match(/^\s+/);
                return null !== n &&
                n[0].length >= i.length ? e.slice(i.length) : e
              }
            ).join('\n')
          }(i, n[3] || '');
          return {
          ...
          for (
            ...
            if (r = n = p[l], l !== g - 1) {
              if (
                ...
                this.options.pedantic ? o[1].length > s[1].length : o[1].length > s[0].length ||
                3 < o[1].length
              ) {
                p.splice(l, 2, p[l] + '\n' + p[l + 1]),
                l--,
                ...
                !this.options.pedantic ||
                this.options.smartLists ? o[2][o[2].length - 1] !== c[c.length - 1] : u == (1 === o[2].length)
              ) &&
              (
                i = p.slice(l + 1).join('\n'),
      ...
      e.prototype.tag = function (e, n, i) {
        ...
        (n = !1),
        !i &&
        /^<(pre|code|kbd|script)(\s|>)/i.test(e[0]) ? i = !0 : i &&
      ...
      e.prototype.link = function (e) {
        ...
        if (n) {
          ...
          i = n[2],
          o = '';
          return this.options.pedantic ? (t = /^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(i)) &&
          (i = t[1], o = t[3]) : o = n[3] ? n[3].slice(1, - 1) : '',
          i = i.trim(),
          en(
            n,
            {
              href: (
                i = /^</.test(i) ? this.options.pedantic &&
                !/>$/.test(e) ? i.slice(1) : i.slice(1, - 1) : i
              ) &&
      ...
      e.prototype.strong = function (e, n, i) {
        ...
        if (
          o &&
          (!o[1] || o[1] && ('' === i || this.rules.inline.punctuation.exec(i)))
        ) {
    ...
    Ne._comment = /<!--(?!-?>)[\s\S]*?(?:-->|$)/,
    Ne.html = Ve(Ne.html, 'i').replace('comment', Ne._comment).replace('tag', Ne._tag).replace(
      'attribute',
      / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/
    ).getRegex(),
    ...
    Ze._comment = Ve(Ne._comment).replace('(?:-->|$)', '-->').getRegex(),
    ...
    function un(e) {
      for (var n, i = '', o = e.length, t = 0; t < o; t++) n = e.charCodeAt(t),
    ...
    var fn = function () {
      function i(e) {
        ...
        this.options.pedantic ? (e.block = tn.pedantic, e.inline = an.pedantic) : this.options.gfm &&
        (
          e.block = tn.gfm,
      ...
      i.prototype.blockTokens = function (e, n, i) {
        ...
        for (
          ...
          (e = e.replace(/^ +$/gm, ''));
          e;
        ) if (o = this.tokenizer.space(e)) e = e.substring(o.raw.length),
        o.type &&
        n.push(o);
         else if (o = this.tokenizer.code(e, n)) e = e.substring(o.raw.length),
        o.type ? n.push(o) : ((r = n[n.length - 1]).raw += '\n' + o.raw, r.text += '\n' + o.text);
         else if (o = this.tokenizer.fences(e)) e = e.substring(o.raw.length),
        n.push(o);
         else if (o = this.tokenizer.heading(e)) e = e.substring(o.raw.length),
        n.push(o);
         else if (o = this.tokenizer.nptable(e)) e = e.substring(o.raw.length),
        n.push(o);
         else if (o = this.tokenizer.hr(e)) e = e.substring(o.raw.length),
        n.push(o);
         else if (o = this.tokenizer.blockquote(e)) e = e.substring(o.raw.length),
        ...
        n.push(o);
          ...
          n.push(o)
        } else if (o = this.tokenizer.html(e)) e = e.substring(o.raw.length),
        n.push(o);
         else if (i && (o = this.tokenizer.def(e))) e = e.substring(o.raw.length),
        this.tokens.links[o.tag] ||
        (this.tokens.links[o.tag] = {
          href: o.href,
          title: o.title
        });
         else if (o = this.tokenizer.table(e)) e = e.substring(o.raw.length),
        n.push(o);
         else if (o = this.tokenizer.lheading(e)) e = e.substring(o.raw.length),
        n.push(o);
         else if (i && (o = this.tokenizer.paragraph(e))) e = e.substring(o.raw.length),
        n.push(o);
         else if (o = this.tokenizer.text(e, n)) e = e.substring(o.raw.length),
        o.type ? n.push(o) : ((r = n[n.length - 1]).raw += '\n' + o.raw, r.text += '\n' + o.text);
         else if (e) {
      ...
      i.prototype.inline = function (e) {
        for (var n, i, o, t, a, r = e.length, c = 0; c < r; c++) switch ((a = e[c]).type) {
          ...
          case 'table':
            ...
            for (o = a.cells.length, n = 0; n < o; n++) for (t = a.cells[n], a.tokens.cells[n] = [], i = 0; i < t.length; i++) a.tokens.cells[n][i] = [],
      ...
      i.prototype.inlineTokens = function (e, n, i, o) {
        ...
        if (this.tokens.links) {
          ...
          (
            u = u.slice(0, a.index) + '[' + rn('a', a[0].length - 2) + ']' + u.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex)
          )
        }
        ...
        for (; e; ) if (r || (c = ''), r = !1, t = this.tokenizer.escape(e)) e = e.substring(t.raw.length),
        n.push(t);
         else if (t = this.tokenizer.tag(e, i, o)) e = e.substring(t.raw.length),
        i = t.inLink,
        o = t.inRawBlock,
        n.push(t);
         else if (t = this.tokenizer.link(e)) e = e.substring(t.raw.length),
        'link' === t.type &&
        (t.tokens = this.inlineTokens(t.text, [], !0, o)),
        n.push(t);
         else if (t = this.tokenizer.reflink(e, this.tokens.links)) e = e.substring(t.raw.length),
        'link' === t.type &&
        (t.tokens = this.inlineTokens(t.text, [], !0, o)),
        n.push(t);
         else if (t = this.tokenizer.strong(e, u, c)) e = e.substring(t.raw.length),
        t.tokens = this.inlineTokens(t.text, [], i, o),
        n.push(t);
         else if (t = this.tokenizer.em(e, u, c)) e = e.substring(t.raw.length),
        t.tokens = this.inlineTokens(t.text, [], i, o),
        n.push(t);
         else if (t = this.tokenizer.codespan(e)) e = e.substring(t.raw.length),
        n.push(t);
         else if (t = this.tokenizer.br(e)) e = e.substring(t.raw.length),
        n.push(t);
         else if (t = this.tokenizer.del(e)) e = e.substring(t.raw.length),
        t.tokens = this.inlineTokens(t.text, [], i, o),
        n.push(t);
         else if (t = this.tokenizer.autolink(e, un)) e = e.substring(t.raw.length),
        n.push(t);
         else if (i || !(t = this.tokenizer.url(e, un))) {
          if (t = this.tokenizer.inlineText(e, o, cn)) e = e.substring(t.raw.length),
          c = t.raw.slice( - 1),
          r = !0,
          n.push(t);
           else if (e) {
        ...
        } else e = e.substring(t.raw.length),
        n.push(t);
        return n
      },
      ...
      i.prototype.parse = function (e, n) {
        ...
        for (var i, o, t, a, r, c, u, f, p, d, g, s, l, v, h, _ = '', m = e.length, b = 0; b < m; b++) switch ((f = e[b]).type) {
          ...
          case 'code':
            ...
            continue;
          case 'table':
            for (c = p = '', t = f.header.length, i = 0; i < t; i++) c += this.renderer.tablecell(
    ...
    function An(e, i) {
      if (
        void 0 === i &&
        (i = '<ul class="app-sub-sidebar">{inner}</ul>'),
        !e ||
        !e.length
      ) return '';
      var o = '';
    ...
    function jn(e, t) {
      return e.replace(
        ...
        function (e, n) {
          ...
          i,
          i = n ? e &&
          /unicode/.test(n) ? '<span class="emoji">' + n.replace('unicode/', '').replace(/\.png.*/, '').split('-').map(function (e) {
            return '&#x' + e + ';'
      ...
      function (e) {
        ...
        g = function (u) {
              ...
              clone: function i(e, o) {
                ...
                switch (o = o || {
                  ...
                  case 'Object':
                    ...
                    for (var a in t = {}, o[n] = t, e) e.hasOwnProperty(a) &&
                    (t[a] = i(e[a], o));
                    return t;
                  case 'Array':
            ...
            languages: {
              ...
              insertBefore: function (i, e, n, o) {
                ...
                for (t in a) if (a.hasOwnProperty(t)) {
                  if (t == e) for (var c in n) n.hasOwnProperty(c) &&
                  (r[c] = n[c]);
                  n.hasOwnProperty(t) ||
                  (r[t] = a[t])
                }
              ...
              DFS: function e(n, i, o, t) {
                ...
                (
                  ...
                  t[u(r)] ? 'Array' !== c ||
                  t[u(r)] ||
                  (t[u(r)] = !0, e(r, i, a, t)) : (t[u(r)] = !0, e(r, i, null, t))
                )
              }
            },
            plugins: {
                    ...
                    for (
                      ...
                      if (!(b instanceof T)) {
                        ...
                        if (l) {
                          ...
                          S = m;
                          for (S += _.value.length; S <= y; ) _ = _.next,
                          S += _.value.length;
                          if (S -= _.value.length, m = S, _.value instanceof T) continue;
                          for (var A = _; A !== i.tail && (S < x || 'string' == typeof A.value); A = A.next) w++,
                          S += A.value.length;
                          w--,
                          b = n.slice(m, S),
                          k.index -= m
          ...
          (
            ...
            'interactive' === e &&
            o &&
            o.defer ? document.addEventListener('DOMContentLoaded', t) : window.requestAnimationFrame ? window.requestAnimationFrame(t) : window.setTimeout(t, 16)
          ),
          R
        }(
        ...
        g.languages.javascript = g.languages.extend(
          'clike',
          {
            'class-name': [
            ...
            function (e) {
              ...
              (
                ...
                r.onreadystatechange = function () {
                  ...
                  (
                    r.status < 400 &&
                    r.responseText ? o(r.responseText) : 400 <= r.status ? a('✖ Error ' + r.status + ' while fetching file: ' + r.statusText) : a('✖ Error: File does not exist or is empty')
                  )
                },
                r.send(null)
              )
    ...
    Object.defineProperties(
      qn.languages['markup-templating'] = {},
      {
        buildPlaceholders: {
                ...
                for (var i = 0; i < n.length && !(d >= g.length); i++) {
                  ...
                  'string' == typeof u.content ? (
                    ...
                    (
                      ...
                      r &&
                      c.push.apply(c, e([r])),
                      'string' == typeof u ? n.splice.apply(n, [
                        i,
                        1
                      ].concat(c)) : u.content = c
                    )
                  ) : u.content &&
                  e(u.content)
                }
    ...
    function In(t, e) {
      ...
      this.toc = [],
      this.cacheTOC = {},
      this.linkTarget = t.externalLinkTarget ||
      '_blank',
      this.linkRel = '_blank' === this.linkTarget ? t.externalLinkRel ||
      'noopener' : '',
      this.contentBase = e.getBasePath();
      var n = this._initRenderer();
      this.heading = n.heading;
      var r = o(e = t.markdown || {
      }) ? e(Sn, n) : (Sn.setOptions(m(e, {
    ...
    In.prototype.compileEmbed = function (e, n) {
      ...
      a = t.str,
      t = t.config;
      if (n = a, t.include) return R(e) ||
      (e = q(this.contentBase, C(this.router.getCurrentPath()), e)),
      t.type &&
      (o = Hn[t.type]) ? (i = o.call(this, e, n)).type = t.type : (
        o = 'code',
        /\.(md|markdown)/.test(e) ? o = 'markdown' : /\.mmd/.test(e) ? o = 'mermaid' : /\.html?/.test(e) ? o = 'iframe' : /\.(mp4|ogg)/.test(e) ? o = 'video' : /\.mp3/.test(e) &&
        (o = 'audio'),
    ...
    In.prototype._initRenderer = function () {
      ...
      t.link = (
        ...
        i.link = function (e, n, i) {
          ...
          return u = t.target ||
          u,
          r = '_blank' === u ? f.config.externalLinkRel ||
          'noopener' : '',
          n = a,
          R(e) ||
          f._matchNotCompileLink(e) ||
          t.ignore ? (
            R(e) ||
            './' !== e.slice(0, 2) ||
            (
      ...
      t.image = (
        ...
        o.image = function (e, n, i) {
          ...
          a.class &&
          t.push('class="' + a.class + '"'),
          a.id &&
          t.push('id="' + a.id + '"'),
          R(e) ||
          (o = q(p, C(d.getCurrentPath()), e)),
      ...
      t.list = {
        ...
        n = n ? 'ol' : 'ul';
        return '<' + n + ' ' + [/<li class="task-list-item">/.test(e.split('class="task-list"') [0]) ? 'class="task-list"' : '',
        i &&
        1 < i ? 'start="' + i + '"' : ''].join(' ').trim() + '>' + e + '</' + n + '>'
      },
      t.listitem = {
        renderer: e
    ...
    In.prototype.sidebar = function (e, n) {
      ...
      if (e) t = this.compile(e);
        ...
        for (var a = 0; a < i.length; a++) if (i[a].ignoreSubHeading) {
          var r = i[a].level;
          i.splice(a, 1);
          for (var c = a; c < i.length && r < i[c].level; c++) i.splice(c, 1) &&
          c-- &&
          a++;
          a--
        }
    ...
    In.prototype.subSidebar = function (e) {
      if (e) {
        ...
        1 === o[0].level &&
        o.shift();
        for (var t = 0; t < o.length; t++) o[t].ignoreSubHeading &&
        o.splice(t, 1) &&
        t--;
        e = i[n] ||
        zn(o, e);
    ...
    function Yn(e, n, i) {
      ...
      a,
      r;
      return n = 'function' == typeof i ? i(n) : 'string' == typeof i ? (
        a = [],
        r = 0,
        (o = i).replace(
          V,
    ...
    function Gn(e) {
      ...
      if (e = e || '<h1>404 - Not found</h1>', 'Vue' in window) for (
        var a = 0,
        r = k('.markdown-section > *').filter(n);
        a < r.length;
        a += 1
      ) {
        var c = r[a];
        2 === t ? c.__vue__.$destroy() : 3 === t &&
        c.__vue_app__.unmount()
      }
      if (
        this._renderTo(o, e),
        i.loadSidebar ||
        ...
        (
          ...
          p.push.apply(
            ...
            k('.markdown-section > *').filter(
              ...
              function (e) {
                return e.tagName.toLowerCase() in (i.vueComponents || {
                }) ||
        ...
        for (var g = 0, s = p; g < s.length; g += 1) {
          ...
          (
            h.setAttribute(v, ''),
            2 === t ? (_.el = void 0, new window.Vue(_).$mount(h)) : 3 === t &&
            (
    ...
    Jn = function (e) {
      ...
      ((n.prototype = Object.create(e && e.prototype)).constructor = n).prototype.initPlugin = function () {
        var n = this;
        [].concat(this.config.plugins).forEach(
          function (e) {
            try {
              o(e) &&
              e(n._lifecycle, n)
      ...
      (
        ...
        function (e) {
          ...
          n.prototype._fetch = function (i) {
            ...
            f = this.route.query,
            p = this.route.path;
            g(p) ? (history.replaceState(null, '', '#'), this.router.normalize()) : (
              t = E(f, [
                'id'
              ]),
          ...
          n.prototype._fetchCover = function () {
            ...
            if (i) {
              ...
              e = this.route.path;
              'string' == typeof i ? '/' === e &&
              (r = i) : r = Array.isArray(i) ? - 1 < i.indexOf(e) &&
              '_coverpage' : !0 === (e = i[e]) ? '_coverpage' : e;
              var c = Boolean(r) &&
              this.config.onlyCover;
              return r ? (
            ...
            if (t) {
              e = function (n, e) {
                ...
                switch (typeof t) {
                  ...
                  case 'object':
                    o = (
                      i = Object.keys(t).sort(function (e, n) {
          ...
          n.prototype.initFetch = function () {
            ...
            this.rendered ? (
              ...
              i &&
              e &&
              (e.parentNode.innerHTML += window.__SUB_SIDEBAR__),
          ...
          function (e) {
            ...
            n.prototype.initEvent = function () {
              ...
              this.config.coverpage ? s ||
              p('scroll', K) : h.classList.add('sticky')
            },
            n
          }(
            function (e) {
              ...
              n.prototype._renderSidebar = function (e) {
                ...
                o = n.subMaxLevel,
                t = n.loadSidebar;
                if (n.hideSidebar) return [document.querySelector('aside.sidebar'),
                document.querySelector('button.sidebar-toggle')].filter(function (e) {
                  return !!e
                }).forEach(function (e) {
                ...
                t &&
                i ? i.parentNode.innerHTML += this.compiler.subSidebar(o) ||
              ...
              n.prototype._renderCover = function (e, n) {
                ...
                e ? (
                  S(o, 'add', 'show'),
                  (
                    n = (i = this.coverIsHTML ? e : this.compiler.cover(e)).trim().match(
                      '<p><img.*?data-origin="(.*?)"[^a]+alt="(.*?)">([^<]*?)</p>$'
                    )
                  ) &&
                  (
                    'color' === n[2] ? o.style.background = n[1] + (n[3] || '') : (
                      e = n[1],
                      S(o, 'add', 'has-mask'),
                      R(n[1]) ||
                      (e = q(this.router.getBasePath(), n[1])),
              ...
              n.prototype._updateRender = function () {
                ...
                n &&
                (
                  f(e.config.nameLink) ? n.setAttribute('href', i) : 'object' == typeof i &&
                  (
              ...
              n.prototype.initRender = function () {
                ...
                u ? (
                  ...
                  (
                    f += (
                      ...
                      ) + '"><div class="mask"></div><div class="cover-main"><!--cover--></div></section>'
                    )
                  ),
                  e.logo &&
                  (
                  ...
                  f += (
                    ...
                    ) + '<section class="content"><article class="markdown-section" id="main"><!--main--></article></section></main>'
                  ),
                ...
                (
                  v.head.appendChild(
                    w(
                      'div',
                      '<style>:root{--theme-color: ' + e.themeColor + ';}</style>'
                    ).firstElementChild
                  ),
                  a = e.themeColor,
                  window.CSS &&
                  ...
                  (
                    ...
                    [].forEach.call(
                      e,
                      function (e) {
                        'STYLE' === e.nodeName ? Q(e, a) : 'LINK' === e.nodeName &&
                        (
                  ...
                  e.prototype.initRouter = function () {
                    ...
                    e.onchange(
                      function (e) {
                        n.updateRender(),
                        n._updateRender(),
                        U.path !== n.route.path ? (n.$fetch(d, n.$resetEvents.bind(n, e.source)), U = n.route) : n.$resetEvents(e.source)
                      }
                    )
                  },
                  e
